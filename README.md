...
> Netflix 사용자 데이터 기반 EDA · 피처 엔지니어링 · 머신러닝 모델링 · Streamlit 대시보드
...
|                                                           **모델링<br/>회의록 작성**                                                           | **프론트엔드** |                                                  **데이터 전처리<br/>PPT 작성<br/>기획 및 발표**                                                  |                                                        **GitHub 총괄 관리<br/>모델링**                                                        |                                                       **노션 정리<br/>프론트엔드<br/>Figma UI 디자인**                                                        | **데이터 전처리** |
...
| `user_data_to_analysis.csv` | EDA용 통합 데이터 | 위 두 테이블 병합 결과 |
...
## 🗺️ 데이터 구조 ERD
<div align="left"> <img width="1307" height="1397" alt="Image" src=" 09_assets/erd.png" width="10%" height="10%" /> </div>
...
> 📸 **스크린샷 / GIF**  
> *(추후 이미지를 `assets/` 폴더에 저장 후 아래 경로에 삽입해 주세요)*
> ```
